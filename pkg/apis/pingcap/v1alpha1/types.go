...
// InitContainerSpec defines the configuration for an init container.
// +k8s:openapi-gen=true
type InitContainerSpec struct {
	// Name specifies the name of the init container.
	Name string `json:"name,omitempty"`
	// Image specifies the image of the init container.
...
type TiCDCSpec struct {
	...
	// Sink is the sink configuration for TiCDC
	// +optional
	Sink *SinkSpec `json:"sink,omitempty"`
}

// SecretKeySelector allows referencing a key in a Secret.
...
type SinkConfig struct {
	...
	AccessKeySecretRef       *SecretKeySelector `json:"accessKeySecretRef,omitempty"`
...
// REMOVE the following duplicate definitions if they exist in this file:
// type TiCDCSpec struct { ... }
// type SinkSpec struct { ... }
// type SecretKeySelector struct { ... }
